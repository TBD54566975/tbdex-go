...
func (r *RFQ) UnmarshalJSON(data []byte, requireAllPrivateData bool) error {
...
func (r *RFQ) verifyAllPrivateData() error {
	...
	if err := tbdex.VerifyDigest(r.Data.ClaimsHash, payload); err != nil { return err }
	...
	if err := tbdex.VerifyDigest(r.Data.Payin.PaymentDetailsHash, payload); err != nil { return err }
	...
	if err := tbdex.VerifyDigest(r.Data.Payout.PaymentDetailsHash, payload); err != nil { return err }
